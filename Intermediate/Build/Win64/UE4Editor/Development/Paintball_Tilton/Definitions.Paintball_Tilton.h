...
#define ORIGINAL_FILE_NAME "UE4Editor-Paintball_Tilton.dll"
#define UE_IS_ENGINE_MODULE 0
#define UE_BUILD_DEVELOPMENT_WITH_DEBUGGAME 0
#define UE_PROJECT_NAME Paintball_Tilton
#define DEPRECATED_FORGAME DEPRECATED
#define PAINTBALL_TILTON_API DLLEXPORT
